...
Exact timing for the fit isn't recorded exactly in this document but, generally, **1-2 hours** on an Apple M1 Silicon laptop has been the experience. Estimates of the fixed effects from the `glmmLDTS` model are provided below in @tbl-glmm-fixed-effects.
